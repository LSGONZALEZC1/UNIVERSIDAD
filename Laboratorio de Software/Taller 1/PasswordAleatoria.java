...
class Main
{
  ...
  public static String PasswordAleatoria(int long_password){
    ...
    // StringBuilder: es una clase que permite crear objetos que almacenan cadenas de caracteres que pueden ser modificados en necisidad de crear nuevos objetos, en este caso la creacion de contraseñas aleatorias
